...
public class BonusControl : MonoBehaviour
{
    ...
    public MoveText[] moveText;    // Start is called before the first frame update
    ...
    IEnumerator MoveToWinPlace()
    {
        ...
        for (int i = chocPlace + 1; i < chocPlace + currentReward + 1; i++)
        {
        ...
        displayCredit.text = gameManager.displayTotalMoney.text;
        gameManager.winAmtText.text = winAmt.ToString();
